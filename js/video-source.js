...
export function loadYouTube(url) {
	...
	playerEl.innerHTML = `<iframe src="https://www.youtube.com/embed/${ytId}?enablejsapi=1&autoplay=1&mute=1&controls=0&disablekb=1&fs=0&modestbranding=1&rel=0&playsinline=1" frameborder="0" allow="autoplay" style="width:100%;height:100%;"></iframe>`;
	showVideoPlayer();
